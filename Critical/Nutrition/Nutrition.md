# Enternal Nutrition (tube fedding or using stoma)

### 1. **assess need for enternal feeding (indication)**

- for patients who can't eat orally maybe due to <mark>impaired gag reflexes, weak jaw muscles, oral surgery</mark>, or for patient that can't get enough nutrients orally to meet his daily requirements or for <mark>increase in metabolic demands situations e:g burns or trauma</mark>
- Severe eating disorders (anorexia nervosa)
- Head and neck cancers or an injury that makes swallowing difficult <mark>(dysphagia)</mark>
...
- conditions that interfere with your ability to absorb nutrients <mark>(like severe Crohn’s disease or celiac disease.)</mark>
- Recent surgery or medical illness that’s affected your ability to swallow.
- Neurological disorders, including <mark>stroke and paralysis.</mark>
- <mark>Unconsciousness</mark> (being in a coma).
...
- **others**: prolonged ileus, severe diarrhea, vomiting and enteric fistula
...
**enternal feeding may be through**:
- oro /  Nasogastric
- oro / Nasojejunal
- Gastrostomy
- jejunostomy
...
> [!NOTE]
> - it's better to insert gastric tube orally if patient is intubated to prevent sinusitis and possible VAP infection.
> - if patient is not intubated insert the Gastric tube nasally
> - duodenal and jejunal tubes decrease the risk of aspiration

> [!IMPORTANT]
> - Naso/Oro gastric or Naso/Oro duodental or Naso/Oro jejunal are short term tubes that should be maintained for <mark>less than 4 weeks maximum</mark> and replaced with new ones
> - gastrostomy, duodenostomy, jejunostomy are long term for <mark>more than 4 weeks</mark>, it has a high risk of infection at the surgical site

**indication of jejunal tubes**:
- any refractory or permanent problem in the aerodigestive tract (from mouth to esophagus) e:g <mark>neuromuscular diseases, structural abnormalities, gastroparesis</mark>
- persistent high GRV
- patient who require supine position , you can't feed a patient when in supine position so if a patient has to be in supine position the tube must reached the jejenum (to decrease risk of aspiration )

### 5. **assess type of feeding**
...
- **Cyclic feeding**: it is given at a faster rate over a shorter period of time

6. ### assess GRV 
تعرف ان المعده ممكن تشيل كمية اكل وميه لحد ما تمتد ل اكتر من 15 مره ضعف حجمها وهي فاضيه

في مصطلح اسمه gastric emptying وده بيدل على سرعة انتقال الاكل من المعده للاثني عشر او اللي هي ال duodenum 

فالاغلب الاكل بيقعد من ساعه ونص ل ساعتين عشان ينتقل لل duodenum 

لو اخد اكتر من كده بنسمي الحاله دي gastroparesis

طبعا الاكل اللي انت بتاكله مش كله بينتقل لل امعاء بالسرعه نفسها , يعني لو شربت ميه مثلا ممكن توصل الامعاء لحظيا, بس كل ما كثافة الاكل تزيد كل ما انتقاله للامعاء هيطول معاك شويه عشان لازم يتهضم الاول فالمعده كويس ويوصل ل قوام معين قبل ما يروح الامعاء
...
1. assess for signs of inflammation (redness, soreness, warmth, swelling), drainage or bledding, skin breakdown
2. oral and nasal care
3. dressing on stoma
4. replace tube place if infection signs are present

##### maintian tube patency

- continuous flushing with water 30 ml of water before and after each feeding, use Y port to flush every 3 / 4 hours if in continuous feeding, even when feeding is held for any reason tube must be flushe every 3 hours
- crash medication (crashable ones) and disolve in water before administration
> [!NOTE]
...
##### 1. **Extended-Release and Controlled-Release Medications**
   - **Reason**: Crushing these medications can lead to the rapid release and absorption of the drug, increasing the risk of overdose and side effects.
   - **Examples**: 
...
##### 2. **Enteric-Coated Medications**
   - **Reason**: Enteric coatings protect the stomach from irritation or protect the drug from being destroyed by stomach acid. Crushing can destroy this coating.
   - **Examples**:
     - Aspirin EC
     - Pantoprazole (Protonix)
     - Diclofenac EC

##### 3. **Medications with Mucosal Irritation Potential**
   - **Reason**: Crushing these can cause irritation to the mouth, esophagus, or stomach lining.
   - **Examples**:
     - Alendronate (Fosamax)
     - Potassium chloride (Klor-Con)

##### 4. **Sublingual or Buccal Medications**
   - **Reason**: These medications are designed for absorption through the oral mucosa and should not be swallowed or crushed.
   - **Examples**:
     - Nitroglycerin (Nitrostat)
     - Buprenorphine (Suboxone)

##### 5. **Medications with a Narrow Therapeutic Index**
   - **Reason**: Precise dosing is critical for efficacy and safety; crushing can lead to unpredictable dosing.
   - **Examples**:
     - Warfarin (Coumadin)
     - Lithium (Lithobid)

##### 6. **Hazardous Medications**
   - **Reason**: Crushing can release drug particles that are dangerous to handlers or patients.
   - **Examples**:
     - Chemotherapy drugs (e.g., Capecitabine)
     - Hormonal medications (e.g., Finasteride)

##### 7. **Medications with Special Delivery Systems**
   - **Reason**: These drugs often have special coatings or layers that control the release and absorption.
   - **Examples**:
     - Mesalamine (Asacol)
     - Tamsulosin (Flomax)

Always consult a pharmacist or refer to specific guidelines like the ISMP "Do Not Crush" list for the most accurate and comprehensive information.

> [!IMPORTANT]
> - dont' mix the medication with any type of feeding formulas
> - crush carefully and disolve in water
> - if tube is obstructed try to use warm water to resolve the obstruction, otherwise change the tube
